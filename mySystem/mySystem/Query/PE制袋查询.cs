...
namespace mySystem.Query
{
    public partial class PE制袋查询 : BaseForm
    {
        ...
        public PE制袋查询()
        {
            ...
            if (Parameter.c查询_PE制袋_生产指令 != "")
            {
                comboBox1.Text = Parameter.c查询_PE制袋_生产指令;
            }
            if (Parameter.c查询_PE制袋_表单 != "")
            {
                comboBox2.Text = Parameter.c查询_PE制袋_表单;
            }
        }
        ...
        {
            Parameter.c查询_PE制袋_生产指令 = comboBox1.Text;
        ...
        {
            Parameter.c查询_PE制袋_表单 = comboBox2.Text;
