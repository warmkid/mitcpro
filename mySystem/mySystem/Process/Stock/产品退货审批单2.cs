...
namespace mySystem.Process.Stock
{
    public partial class 产品退货审批单2 : BaseForm
    {
        ...
        void getPeople()
        {
            ...
            da = new OleDbDataAdapter("select * from 库存用户权限 where 步骤='产品退货审批单2'", conn);
        ...
        {
            daOuter = new OleDbDataAdapter("select * from 产品退货审批单2 where 退货申请单编号='" + code + "'", conn);
        ...
        public void print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\tuihuo\表3产品退货审批单（2）.xlsx");
