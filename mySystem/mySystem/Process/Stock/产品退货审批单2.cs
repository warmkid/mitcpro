...
//        OleDbConnection conn;
        ...
        void getPeople()
        {
            ...
            da = new SqlDataAdapter("select * from 库存用户权限 where 步骤='产品退货审批单2'", mySystem.Parameter.conn);
        ...
        {
            daOuter = new SqlDataAdapter("select * from 产品退货审批单2 where 退货申请单编号='" + code + "'", mySystem.Parameter.conn);
