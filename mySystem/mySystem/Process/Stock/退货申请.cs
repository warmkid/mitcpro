...
//        OleDbConnection conn;
        ...
        void getPeople()
        {
            ...
            da = new SqlDataAdapter("select * from 库存用户权限 where 步骤='退货申请'", mySystem.Parameter.conn);
        ...
        {
            daOuter = new SqlDataAdapter("select * from 退货申请 where 退货编号='" + code + "'", mySystem.Parameter.conn);
        ...
        private void btn提交审核_Click(object sender, EventArgs e)
        {
            ...
            da = new SqlDataAdapter("select * from 待审核 where 表名='退货申请' and 对应ID=" + _id, mySystem.Parameter.conn);
