...
//        OleDbConnection conn;
        ...
        void getPeople()
        {
            ...
            da = new OleDbDataAdapter("select * from 库存用户权限 where 步骤='产品退货请验单'", mySystem.Parameter.connOle);
        ...
        {
            daOuter = new OleDbDataAdapter("select * from 产品退货请验单 where 退货申请单编号='" + code + "'", mySystem.Parameter.connOle);
        ...
        private void btn提交审核_Click(object sender, EventArgs e)
        {
            ...
            da = new OleDbDataAdapter("select * from 待审核 where 表名='产品退货请验单' and 对应ID=" + _id, mySystem.Parameter.connOle);
        ...
        public override void CheckResult()
        {
            ...
            {
                // 自动生产评审单1
                da = new OleDbDataAdapter("select * from 产品退货评审单1 where 退货申请单编号='" + _code + "'", mySystem.Parameter.connOle);
                cb = new OleDbCommandBuilder(da);
                dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        public void print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\库存\表5产品退货接请验单.xlsx");
        ...
        private Microsoft.Office.Interop.Excel._Worksheet printValue(Microsoft.Office.Interop.Excel._Worksheet mysheet, Microsoft.Office.Interop.Excel._Workbook mybook)
        {
            ...
            mysheet.Cells[3, 2].Value = dtOuter.Rows[0]["请验人"].ToString();
            mysheet.Cells[3, 4].Value = Convert.ToDateTime(dtOuter.Rows[0]["请验日期"]).ToString("D");
            ...
            mysheet.Cells[7, 2].Value = dtOuter.Rows[0]["审核人"].ToString();
            mysheet.Cells[7, 4].Value = Convert.ToDateTime(dtOuter.Rows[0]["审核日期"]).ToString("D");
