...
//        OleDbConnection conn;
        ...
        void getPeople()
        {
            ...
            da = new SqlDataAdapter("select * from 库存用户权限 where 步骤='产品退货请验单'", mySystem.Parameter.conn);
        ...
        {
            daOuter = new SqlDataAdapter("select * from 产品退货请验单 where 退货申请单编号='" + code + "'", mySystem.Parameter.conn);
        ...
        private void btn提交审核_Click(object sender, EventArgs e)
        {
            ...
            da = new SqlDataAdapter("select * from 待审核 where 表名='产品退货请验单' and 对应ID=" + _id, mySystem.Parameter.conn);
        ...
        public override void CheckResult()
        {
            ...
            {
                // 自动生产评审单1
                da = new SqlDataAdapter("select * from 产品退货评审单1 where 退货申请单编号='" + _code + "'", mySystem.Parameter.conn);
                cb = new SqlCommandBuilder(da);
                dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
