...
namespace mySystem.Extruction.Process
{
    public partial class ExtructionReplaceCore : BaseForm
    {
        ...
        private String table = "吹膜机组换模芯检查表";
        private String tableInfo = "吹膜机组换模芯检查项目";
        ...
        public ExtructionReplaceCore(MainForm mainform, Int32 ID) : base(mainform)
        {
            InitializeComponent();
        ...
        {
            tb更换原因.Enabled = able;
            tb更换后模芯型号.Enabled = able;
            tb更换前模芯型号.Enabled = able;
        ...
        private void GetSettingInfo()
        {
            ...
            //给表里添加内容
            dt设置.Rows.Add("模芯", " 检查模芯位置安装正确，连接牢固。","Yes");
            dt设置.Rows.Add("模环", " 检查模环位置安装正确，连接牢固。", "Yes");
            dt设置.Rows.Add("加热片", " 检查加热片位置安装正确，连接牢固。", "Yes");
            dt设置.Rows.Add("电热偶", " 检查电热偶位置安装正确，连接牢固。", "Yes");
            dt设置.Rows.Add("电源插头", " 检查模头电源插头位置安装正确，连接牢固。", "Yes");
        ...
        private void outerBind()
        {
            ...
            tb更换前模芯型号.DataBindings.Clear();
            tb更换前模芯型号.DataBindings.Add("Text", bs记录.DataSource, "更换前模芯型号");
            tb更换后模芯型号.DataBindings.Clear();
            tb更换后模芯型号.DataBindings.Add("Text", bs记录.DataSource, "更换后模芯型号");
        ...
        private Microsoft.Office.Interop.Excel._Worksheet printValue(Microsoft.Office.Interop.Excel._Worksheet mysheet)
        {
            ...
            mysheet.Cells[3, 5].Value = dt记录.Rows[0]["更换前模芯型号"].ToString();
            ...
            mysheet.Cells[4, 5].Value = dt记录.Rows[0]["更换后模芯型号"].ToString();
            String stringtemp = "";
            ...
            mysheet.Cells[19, 2].Value = stringtemp;
            ...
            mysheet.Cells[19, 5].Value = stringtemp;
            //内表信息
