...
{
    public partial class LDPEBag_checklist : BaseForm
    {
        ...
        public LDPEBag_checklist(MainForm mainform, Int32 ID) : base(mainform)
        {
            InitializeComponent();
        ...
        public void print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\CSBag\SOP-MFG-304-R02A 1#制袋机开机前确认表.xlsx");
