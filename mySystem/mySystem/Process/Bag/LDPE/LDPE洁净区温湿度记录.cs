...
{
    public partial class LDPE洁净区温湿度记录 : mySystem.BaseForm
    {
        ...
        public LDPE洁净区温湿度记录(mySystem.MainForm mainform) : base(mainform)
        {
            InitializeComponent();
        ...
        public LDPE洁净区温湿度记录(mySystem.MainForm mainform, Int32 ID) : base(mainform)
        {
            InitializeComponent();
        ...
        public int print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\LDPE\SOP-MFG-201-R01A 洁净区温湿度记录.xlsx");
