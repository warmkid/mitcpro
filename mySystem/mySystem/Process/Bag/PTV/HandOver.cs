...
namespace mySystem.Process.Bag.PTV
{
    public partial class HandOver : BaseForm
    {
        ...
        {
            __生产指令ID = Parameter.ptvbagInstruID;
            __生产指令编号 = Parameter.ptvbagInstruction;
            __生产日期 = DateTime.Now.Date;
            settingItem = 获取交接班项目();
        }
        ...
        public void print(bool preview)
        {
            ...
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\PTV\SOP-MFG-108-R01A  制袋岗位交接班记录.xlsx");
