...
{
    public partial class PTV产品外包装记录 : mySystem.BaseForm
    {        
        ...
        public PTV产品外包装记录(mySystem.MainForm mainform, Int32 ID) : base(mainform)
        {
            InitializeComponent();
        ...
        public void print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\PTV\6 SOP-MFG-111-R01A 产品外包装记录.xlsx");
