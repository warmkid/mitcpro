...
namespace mySystem.Process.Bag.PTV
{
    public partial class PTVBag_runningrecordofpk : BaseForm
    {
        ...
        private void getPeople()
        {
            ...
            da = new SqlDataAdapter("select * from 用户权限 where 步骤='瓶口焊接机运行记录'", mySystem.Parameter.conn);
        ...
        private void readInnerData(Int32 ID)
        {
            ...
            da记录详情 = new SqlDataAdapter("select * from " + tableInfo + " where T瓶口焊接机运行记录ID = " + ID.ToString(), mySystem.Parameter.conn);
        ...
        private void btn提交审核_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da_temp = new SqlDataAdapter("select * from 待审核 where 表名='瓶口焊接机运行记录' and 对应ID=" + dt记录.Rows[0]["ID"], mySystem.Parameter.conn);
        ...
        private void fill_excel(Microsoft.Office.Interop.Excel._Worksheet mysheet, Microsoft.Office.Interop.Excel._Workbook mybook)
        {
            ...
            mysheet.Cells[7, 5].Value = dt记录.Rows[0]["控制器1参数3"];
            mysheet.Cells[7, 6].Value = dt记录.Rows[0]["控制器1参数4"];
            mysheet.Cells[7, 7].Value = dt记录.Rows[0]["控制器1参数5"];

            mysheet.Cells[7, 8].Value = dt记录.Rows[0]["控制器2参数1"];
            mysheet.Cells[7, 9].Value = dt记录.Rows[0]["控制器2参数2"];
            mysheet.Cells[7, 10].Value = dt记录.Rows[0]["控制器2参数3"];
            mysheet.Cells[7, 11].Value = dt记录.Rows[0]["控制器2参数4"];
            mysheet.Cells[7, 12].Value = dt记录.Rows[0]["控制器2参数5"];


            mysheet.Cells[7, 13].Value = dt记录.Rows[0]["控制器3参数1"];
            mysheet.Cells[7, 14].Value = dt记录.Rows[0]["控制器3参数2"];
            mysheet.Cells[7, 15].Value = dt记录.Rows[0]["控制器3参数3"];
            mysheet.Cells[7, 16].Value = dt记录.Rows[0]["控制器3参数4"];
            mysheet.Cells[7, 17].Value = dt记录.Rows[0]["控制器3参数5"];

            mysheet.Cells[7, 18].Value = dt记录.Rows[0]["控制器4参数1"];
            mysheet.Cells[7, 19].Value = dt记录.Rows[0]["控制器4参数2"];
            mysheet.Cells[7, 20].Value = dt记录.Rows[0]["控制器4参数3"];
            mysheet.Cells[7, 21].Value = dt记录.Rows[0]["控制器4参数4"];
            mysheet.Cells[7, 22].Value = dt记录.Rows[0]["控制器4参数5"];
            ...
            for (int i = 0; i < dt记录详情.Rows.Count; i++)
            {
                ...
                mysheet.Cells[8 + i, 6] = dt记录详情.Rows[i]["控制器1参数4"].ToString();
                mysheet.Cells[8 + i, 7] = dt记录详情.Rows[i]["控制器1参数5"].ToString();
                mysheet.Cells[8 + i, 8] = dt记录详情.Rows[i]["控制器2参数1"].ToString();
                mysheet.Cells[8 + i, 9] = dt记录详情.Rows[i]["控制器2参数2"].ToString();
                mysheet.Cells[8 + i, 10] = dt记录详情.Rows[i]["控制器2参数3"].ToString();
                mysheet.Cells[8 + i, 11] = dt记录详情.Rows[i]["控制器2参数4"].ToString();
                mysheet.Cells[8 + i, 12] = dt记录详情.Rows[i]["控制器2参数5"].ToString();
                mysheet.Cells[8 + i, 13] = dt记录详情.Rows[i]["控制器3参数1"].ToString();
                mysheet.Cells[8 + i, 14] = dt记录详情.Rows[i]["控制器3参数2"].ToString();
                mysheet.Cells[8 + i, 15] = dt记录详情.Rows[i]["控制器3参数3"].ToString();
                mysheet.Cells[8 + i, 16] = dt记录详情.Rows[i]["控制器3参数4"].ToString();
                mysheet.Cells[8 + i, 17] = dt记录详情.Rows[i]["控制器3参数5"].ToString();
                mysheet.Cells[8 + i, 18] = dt记录详情.Rows[i]["控制器4参数1"].ToString();
                mysheet.Cells[8 + i, 19] = dt记录详情.Rows[i]["控制器4参数2"].ToString();
                mysheet.Cells[8 + i, 20] = dt记录详情.Rows[i]["控制器4参数3"].ToString();
        ...
        private void PTVBag_runningrecordofpk_FormClosing(object sender, FormClosingEventArgs e)
        {
