...
namespace mySystem.Process.Bag.BTV
{
    public partial class 产品外观和尺寸检验记录 : BaseForm
    {
        ...
        void variableInit()
        {
            ...
            str生产指令编号 = mySystem.Parameter.bpvbagInstruction;
            ID = i生产指令ID;
            CODE = str生产指令编号;
        }
        ...
        DataRow writeOuterDefault(DataRow dr)
        {
            ...
            log += mySystem.Parameter.userName + " 开始填写产品外观和尺寸检验记录";
            dr["日志"] = log;
            return dr;
        }
        ...
        public int print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\BPVBag\QB-PA-PP-03-R01A 产品外观和尺寸检验记录.xlsx");
