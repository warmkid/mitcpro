...
namespace mySystem.Process.Bag.BTV
{
    public partial class  BTVCutPipeRecord  : BaseForm
    {
        ...
        private void getPeople()
        {
            ...
            da = new SqlDataAdapter("select * from 用户权限 where 步骤='BPV切管记录'", mySystem.Parameter.conn);
        ...
        private void readOuterData(Int32 InstruID, String productCode,String prodbatch,DateTime date)
        {
            ...
            da记录 = new SqlDataAdapter("select * from " + table + " where 生产指令ID = " + InstruID + " and 成品代码 = '" + productCode + "' and 产品批号='" + prodbatch + "' and 生产日期='" + date.ToString("yyyy/MM/dd") + "'", mySystem.Parameter.conn);
        ...
        private void readInnerData(Int32 ID)
        {
            ...
            da记录详情 = new SqlDataAdapter("select * from " + tableInfo + " where TBPV切管记录ID = " + ID, mySystem.Parameter.conn);
        ...
        private void btn提交审核_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da_temp = new SqlDataAdapter("select * from 待审核 where 表名='BPV切管记录' and 对应ID=" + dt记录.Rows[0]["ID"], mySystem.Parameter.conn);
