...
namespace mySystem.Process.Bag.BTV
{
    public partial class BTVRawMaterialDispensing : BaseForm
    {
        ...
        public BTVRawMaterialDispensing(MainForm mainform, int ID)
            : base(mainform)
        {
            InitializeComponent();
        ...
        private void getPeople()
        {
            ...
            da = new OleDbDataAdapter("select * from 用户权限 where 步骤='原材料分装记录'", connOle);
        ...
        public string insId2ins(int ID)
        {
            ...
            OleDbCommand INSANS=new OleDbCommand(sqlStr, connOle);
        ...
        private void readInnerData(Int32 ID)
        {
            ...
            da记录详情 = new OleDbDataAdapter("select * from " + tableInfo + " where T原材料分装记录ID = " + ID.ToString(), connOle);
        ...
        private DataRow writeInnerDefault(Int32 ID, DataRow dr)
        {
            ...
            dr["物料批号"] = "";
            //TO ASK : CAN'T READ 物料批号 IN INSTRUCTION
        ...
        private void setDataGridViewFormat()
        {
            ...
            dataGridView1.Columns["T原材料分装记录ID"].Visible = false;
            //不可用
        ...
        public override void CheckResult()
        {
            ...
            DataTable dt_temp = new DataTable("待审核");
            //BindingSource bs_temp = new BindingSource();
            OleDbDataAdapter da_temp = new OleDbDataAdapter("select * from 待审核 where 表名='原材料分装记录' and 对应ID=" + dt记录.Rows[0]["ID"], mySystem.Parameter.connOle);
            OleDbCommandBuilder cb_temp = new OleDbCommandBuilder(da_temp);
            da_temp.Fill(dt_temp);
