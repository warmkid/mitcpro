...
namespace mySystem.Process.Bag.BTV
{
    public partial class BTVLeakTest : BaseForm
    {
        ...
        */
        ...
        public BTVLeakTest(MainForm mainform, int ID)
            : base(mainform)
        {
        ...
        private void outerBind()
        {
            ...
            tbprefill.DataBindings.Clear();
            tbprefill.DataBindings.Add("Text", bs记录.DataSource, "prefill");
            tbcharde.DataBindings.Clear();
            tbcharde.DataBindings.Add("Text", bs记录.DataSource, "charde");
            tbsettle.DataBindings.Clear();
            tbsettle.DataBindings.Add("Text", bs记录.DataSource, "settle");
            tbtest.DataBindings.Clear();
            tbtest.DataBindings.Add("Text", bs记录.DataSource, "test");
            tbfinel.DataBindings.Clear();
            tbfinel.DataBindings.Add("Text", bs记录.DataSource, "finel");
            tbfiner.DataBindings.Clear();
            tbfiner.DataBindings.Add("Text", bs记录.DataSource, "finer");
            tbflow.DataBindings.Clear();
            tbflow.DataBindings.Add("Text", bs记录.DataSource, "flow");
        ...
        private bool TextBox_check()
        {
            ...
            List<TextBox> TextBoxList = new List<TextBox>(new TextBox[] { tbprefill, tbcharde, tbsettle, tbtest, tbfinel, tbfiner, tbflow });
            List<String> StringList = new List<String>(new String[] { "prefill","charde","settle","test","finel","finer","flow" });
            int numtemp = 0;
