...
{
    public partial class BPV洁净区温湿度记录 : mySystem.BaseForm
    {
        ...
        public BPV洁净区温湿度记录(mySystem.MainForm mainform, Int32 ID)  : base(mainform)
        {
            InitializeComponent();
        ...
        public void print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\BPVBag\SOP-MFG-201-R01A 洁净区温湿度记录.xlsx");
