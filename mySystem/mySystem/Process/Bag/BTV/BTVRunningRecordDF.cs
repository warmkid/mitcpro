...
namespace mySystem.Process.Bag.BTV
{
    public partial class BTVRunningRecordDF : BaseForm
    {
        ...
        private void outerBind()
        {
            ...
            cmb膜代码.DataBindings.Add("Text", bs记录.DataSource, "膜或袋体代码");
        ...
        public void print(bool preview)
        {
            ...
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\BPVBag\SOP-MFG-412-R01A  底封机运行记录.xlsx");
            // 选择一个Sheet，注意Sheet的序号是从1开始的
            Microsoft.Office.Interop.Excel._Worksheet my = wb.Worksheets[2];
            // 设置该进程是否可见
            //oXL.Visible = true;
            // 修改Sheet中某行某列的值
            my.Cells[3, 1].Value = "膜或袋体代码：" + cmb膜代码.Text;
            my.Cells[3, 6].Value = "产品代码：" + tb产品代码.Text;
