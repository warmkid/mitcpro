...
namespace mySystem.Process.Bag.CS
{
    public partial class CS洁净区温湿度记录 : BaseForm
    {
        ...
        public int print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\CSBag\SOP-MFG-201-R01A 洁净区温湿度记录.xlsx");
        ...
        private void CS洁净区温湿度记录_FormClosing(object sender, FormClosingEventArgs e)
        {
