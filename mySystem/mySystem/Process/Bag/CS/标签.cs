...
namespace mySystem.Process.Bag.CS
{
    public partial class 标签 : Form
    {
        ...
        void getData()
        {
            ...
            da = new OleDbDataAdapter("select * from 生产指令 where ID="+mySystem.Parameter.csbagInstruID,mySystem.Parameter.connOle);
            dt = new System.Data.DataTable();
            da.Fill(dt);
            名称 = dt.Rows[0]["产品名称"].ToString();
            tc产品名称.Text = 名称;

            da = new OleDbDataAdapter("select * from 生产指令详细信息 where T生产指令ID=" + mySystem.Parameter.csbagInstruID, mySystem.Parameter.connOle);
            dt = new System.Data.DataTable();
            da.Fill(dt);
