...
namespace mySystem.Process.Bag
{
    public partial class CSBag_CheckBeforePower : BaseForm
    {
        ...
        public void print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\CSBag\SOP-MFG-303-R02A  2# 制袋机开机前确认表.xlsx");
        ...
        private Microsoft.Office.Interop.Excel._Worksheet printValue(Microsoft.Office.Interop.Excel._Worksheet mysheet, Microsoft.Office.Interop.Excel._Workbook mybook)
        {
            ...
            //外表信息
            mysheet.Cells[18 + ind, 1].Value = " 备注： " + dt记录.Rows[0]["备注"].ToString();
            String stringtemp = "";
            ...
            mysheet.Cells[19 + ind, 1].Value = stringtemp;
            ...
            mysheet.Cells[19 + ind, 5].Value = stringtemp;
            //加页脚
            int sheetnum;
