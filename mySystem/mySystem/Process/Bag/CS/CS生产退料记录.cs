...
{
    public partial class CS生产退料记录 : mySystem.BaseForm
    {
        ...
        public CS生产退料记录(mySystem.MainForm mainform, Int32 ID) : base(mainform)
        {
            InitializeComponent();
...
//                }
        ...
        public void print(bool isShow)
        {
            ...
            // 利用这个进程打开一个Excel文件
            Microsoft.Office.Interop.Excel._Workbook wb = oXL.Workbooks.Open(System.IO.Directory.GetCurrentDirectory() + @"\..\..\xls\CSBag\SOP-MFG-102-R02A 生产退料记录.xlsx");
