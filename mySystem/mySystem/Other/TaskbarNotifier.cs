...
namespace CustomUIControls
{
    ...
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        protected Font normalTitleFont = new Font("Arial", 15, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font hoverTitleFont = new Font("Arial", 15, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("Arial", 14.25F, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("Arial", 14.25F, FontStyle.Regular, GraphicsUnit.Pixel);
