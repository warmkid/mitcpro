...
namespace mySystem.Setting
{
    public partial class PTV制袋设置 : BaseForm
    {
        ...
        private void Bind()
        {
            ...
            da开机 = new SqlDataAdapter("select * from 设置生产开机前确认项目", mySystem.Parameter.conn);
            ...
            da产品 = new SqlDataAdapter("select * from 设置PTV产品", mySystem.Parameter.conn);
            ...
            da产品编码 = new SqlDataAdapter("select * from 设置PTV产品编码", mySystem.Parameter.conn);
            ...
            da产品规格 = new SqlDataAdapter("select * from 设置PTV制袋产品规格", mySystem.Parameter.conn);
            ...
            da封边 = new SqlDataAdapter("select * from 设置PTV制袋封边", mySystem.Parameter.conn);
            ...
            da工艺 = new SqlDataAdapter("select * from 设置PTV制袋工艺", mySystem.Parameter.conn);
