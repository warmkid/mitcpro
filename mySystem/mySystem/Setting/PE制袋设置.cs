...
namespace mySystem.Setting
{
    public partial class PE制袋设置 : BaseForm
    {
        ...
        private void Bind()
        {
            ...
            da产品 = new SqlDataAdapter("select * from 设置LDPE产品", mySystem.Parameter.conn);
            ...
            da产品编码 = new SqlDataAdapter("select * from 设置LDPE产品编码", mySystem.Parameter.conn);
            ...
            da产品规格 = new SqlDataAdapter("select * from 设置LDPE制袋产品规格", mySystem.Parameter.conn);
            ...
            da封边 = new SqlDataAdapter("select * from 设置LDPE制袋封边", mySystem.Parameter.conn);
            ...
            da工艺 = new SqlDataAdapter("select * from 设置LDPE制袋工艺", mySystem.Parameter.conn);
