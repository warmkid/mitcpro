...
namespace mySystem.Setting
{
    public partial class BPV制袋设置 : BaseForm
    {
        ...
        private void Bind()
        {
            ...
            da开机 = new OleDbDataAdapter("select * from 设置生产前确认项目", mySystem.Parameter.connOle);
            ...
            da产品 = new OleDbDataAdapter("select * from 设置BPV产品", mySystem.Parameter.connOle);
            ...
            da产品编码 = new OleDbDataAdapter("select * from 设置BPV产品编码", mySystem.Parameter.connOle);
            ...
            da产品规格 = new OleDbDataAdapter("select * from 设置BPV制袋产品规格", mySystem.Parameter.connOle);
            ...
            da封边 = new OleDbDataAdapter("select * from 设置BPV制袋封边", mySystem.Parameter.connOle);
            ...
            da工艺 = new OleDbDataAdapter("select * from 设置BPV制袋工艺", mySystem.Parameter.connOle);
